    ...
    return MaterialApp.router(
      ...
      theme: ThemeData(
        ...
        textTheme: const TextTheme(
          ...
          titleMedium: TextStyle(color: AppColors.mainColor, fontSize: 18.0),
          titleSmall: TextStyle(color: AppColors.mainColor, fontSize: 16.0),
          labelLarge: TextStyle(color: AppColors.mainColor, fontSize: 14.0),
          labelMedium: TextStyle(color: AppColors.mainColor, fontSize: 12.0),
          labelSmall: TextStyle(color: AppColors.mainColor, fontSize: 10.0),
          displayLarge: TextStyle(color: AppColors.mainColor, fontSize: 16.0),
          displayMedium: TextStyle(color: AppColors.mainColor, fontSize: 14.0),
          displaySmall: TextStyle(color: AppColors.mainColor, fontSize: 12.0),
        ),
